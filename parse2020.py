...
if __name__ == '__main__':
    ...
    TEST_PATH = os.path.join('data2020', 'T1-test')

    JSON_PATH = 'data2020/json'
    if not os.path.exists(JSON_PATH):
        os.mkdir(JSON_PATH)

    trainset = parse(TRAIN_PATH, ['en', 'es', 'fr', 'ko', 'pt', 'ru'])
    TRAIN_SAVE_PATH = 'data2020/json/train'
    ...
    devset = parse(DEV_PATH, ['en', 'es', 'fr', 'ko', 'pt', 'ru'])
    DEV_SAVE_PATH = 'data2020/json/dev'
    ...
    testset = parse(TEST_PATH, ['en', 'es', 'fr', 'ko', 'pt', 'ru'], testset=True)
    TEST_SAVE_PATH = 'data2020/json/test'
